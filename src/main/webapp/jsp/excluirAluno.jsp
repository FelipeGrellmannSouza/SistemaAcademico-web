		...
		<table border="1">
			...
			<tr>
				...
				<% if (aluno != null && aluno.getDataNascimento() != null) { %>
    				<td><input type="text" size="60" name="txtData" value="<%=data.format(aluno.getDataNascimento())%>" /></td>
				<% } else { %>
    				<td><input type="text" size="60" name="txtData" value="" /></td>
				<% } %>
			</tr>
			...
			<tr>
				<th colspan="2"><a href="html\index.html">Página Principal</a></th>
			</tr>
		</table>
	</form>
</body>
